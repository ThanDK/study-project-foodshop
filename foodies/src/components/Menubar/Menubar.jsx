...
const Menubar = () => {
  ...
  // คำนวณจำนวน 'ประเภท' สินค้าในตะกร้า (ไม่ใช่จำนวนชิ้นทั้งหมด) เพื่อเอาไปแสดงบน badge
  const uniqueItemsinCart = Object.values(quantities).filter(qty => qty > 0).length;
  const navigate = useNavigate();

  // สร้างฟังก์ชัน logout: ต้องเคลียร์ token ทั้งจาก localStorage และ state, ล้างข้อมูลตะกร้า, แล้วค่อย redirect กลับหน้าแรก
  const logout = () => {
